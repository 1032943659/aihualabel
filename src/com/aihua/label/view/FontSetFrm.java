...
public class FontSetFrm extends JFrame {
	...
	public FontSetFrm(JFrame This) {
		...
		Item_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("ItemFontSize")));//配置文件中的值
		...
		other_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("otherFontSize")));
		...
		pn_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("PNFontSize")));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 if(PropertiesConfig.updateProperty("ItemFontSize",Item_slider.getValue()+"",1)==true&&PropertiesConfig.updateProperty("otherFontSize",other_slider.getValue()+"",1)==true&&PropertiesConfig.updateProperty("PNFontSize",pn_slider.getValue()+"",1)==true){
