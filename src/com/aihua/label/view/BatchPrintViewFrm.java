...
import com.aihua.label.util.InsideBoxPanel;
import com.aihua.label.util.OutsideBoxPanel;
	...
	public BatchPrintViewFrm(JFrame This,String s) {
		...
		if (Row.length == 0) {
			if (LabelPrintFrm.printLogSelFrm != null && PrintLogSelFrm.insideToOutFlag == false) {
				...
				labelPrintLog.setNetWeight((String) PrintLogSelFrm.PrintLog_table.getValueAt(row, 12));
				labelPrintLog.setGrossWeight((String) PrintLogSelFrm.PrintLog_table.getValueAt(row, 13));
				labelPrintLog.setProductionDate((String) PrintLogSelFrm.PrintLog_table.getValueAt(row, 14));
		...
		if (LabelPrintFrm.printLogSelFrm != null && PrintLogSelFrm.insideToOutFlag) {
			...
			for (int i = 0; i < row.length; i++) {
				...
				labelPrintLog.setNetWeight((String) PrintLogSelFrm.PrintLog_table.getValueAt(row[i], 12));
				labelPrintLog.setGrossWeight((String) PrintLogSelFrm.PrintLog_table.getValueAt(row[i], 13));
				labelPrintLog.setProductionDate((String) PrintLogSelFrm.PrintLog_table.getValueAt(row[i], 14));
		...
		for (int i = 0; i < Row.length; i++) {
			...
			labelPrintLog.setNetWeight((String) LabelPrintFrm.printList_table.getValueAt(Row[i], 5));
			labelPrintLog.setGrossWeight((String) LabelPrintFrm.printList_table.getValueAt(Row[i], 6));
			labelPrintLog.setProductionDate((String) LabelPrintFrm.printList_table.getValueAt(Row[i], 14));
