...
public class OutBoxSetFrm extends JFrame {
	...
	public OutBoxSetFrm() {
		...
		X_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("outOther_x")));//配置文件中的值
		...
		Y_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("outOther_y")));
		...
		width_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("outOther_width")));
		...
		height_slider.setValue(Integer.valueOf(PropertiesConfig.getFontValues("outOther_height")));
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 if(PropertiesConfig.updateProperty("outOther_x",X_slider.getValue()+"",1)==true&&PropertiesConfig.updateProperty("outOther_y",Y_slider.getValue()+"",1)==true&&PropertiesConfig.updateProperty("outOther_width",width_slider.getValue()+"",1)==true&&PropertiesConfig.updateProperty("outOther_height",height_slider.getValue()+"",1)==true){
