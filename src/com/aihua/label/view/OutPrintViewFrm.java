...
import com.aihua.label.util.MaterialPropertyExcelImport;
import com.aihua.label.util.NumberUtil;
...
public class OutPrintViewFrm extends JFrame {
	...
	public static int outOther_x = Integer.valueOf(PropertiesConfig.getFontValues("outOther_x"));
	public static int outOther_y = Integer.valueOf(PropertiesConfig.getFontValues("outOther_y"));
	public static int outOther_width = Integer.valueOf(PropertiesConfig.getFontValues("outOther_width"));
	public static int outOther_height = Integer.valueOf(PropertiesConfig.getFontValues("outOther_height"));
	JButton button;
	JLabel lblPo1;
	 ...
	 */
	public OutPrintViewFrm(ArrayList<AiHuaLabel> outlabelPrintLog) {
		setResizable(false);
		setTitle("外箱打印预览");
		...
		// 准备数据
		for (AiHuaLabel labelPrintLog : outlabelPrintLog) {
			n_n_Id.add(labelPrintLog.getLabelId() + "");
			...
			MouthCode.add(labelPrintLog.getProductionDate().substring(5, 7));
			...
			PD.add(labelPrintLog.getProductionDate());
			NetWeigth.add(labelPrintLog.getNetWeight());
			GrossWeigth.add(labelPrintLog.getGrossWeight());
		}
			...
			public void actionPerformed(ActionEvent e) {
				if (inputActionformed(e)) {
					if (ComponenetPrintUtil.printComponenet(outBox_panel,1)) {
						...
						labelPrintLog.setNetWeight(netWeigth_textField.getText());
						labelPrintLog.setGrossWeight(grossWeigth_textField.getText());
						labelPrintLog.setProductionDate(out_PD);
						...
						if (LabelPrintFrm.printLogSelFrm != null
							...
							if (labelPrintLogDao.insertPrintLog(labelPrintLog) == 1) {
								...
								try {
									...
									AiHuaLabel labelPrintLog1 = new AiHuaLabel();
...
//		outBoxNum_label.setBounds(320, 186, 120, 20);//354, 178, 80, 28
	...
	protected void deleteTableRow(ActionEvent e, int id) {
		// TODO Auto-generated method stub
		MaterialPropertyDao propertyValueDao = new MaterialPropertyDao();
	...
	protected void SaveToModel(ActionEvent e) {
		MaterialProperty fxstandardValue = new MaterialProperty();
		MaterialPropertyDao propertyValueDao = new MaterialPropertyDao();
