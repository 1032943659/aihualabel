...
public class OutsideBoxPanel extends JPanel{
	...
	public OutsideBoxPanel(LabelPrintLog labelPrintLog) {
...
//		vendorcode_label.setBounds(57, 11, 130, 14);
		...
		vendor_label = new JLabel(labelPrintLog.getProduction_Date().substring(5, 7)+"月");
		...
		TagboxNum_label.setBounds(Integer.valueOf(Config.getValues("outOther_x")), Integer.valueOf(Config.getValues("outOther_y")), Integer.valueOf(Config.getValues("outOther_width")), Integer.valueOf(Config.getValues("outOther_height")));
