...
import com.label.util.ImagePannel;
...
public class LabelPrintFrm extends JFrame {
	...
	public static int itemfontSize = Integer.valueOf(Config.getValues("ItemFontSize"));// 型号规格字体大小
	public static int otherfontSize = Integer.valueOf(Config.getValues("otherFontSize"));// 备注字体大小
	public static int pnfontSize = Integer.valueOf(Config.getValues("PNFontSize"));//PN字体大小
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					UpgraderUtil.autoupgrade(frame);// 自动更新
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (inputActionformed(e)) {// 检查输入和检查是否是补打
					if (Row.length != 0 && Row[0] != -1 && Row.length != 1) {// 选择打印清单打印
						...
						if (bool) {
							LabelPrintLog InsidelabelPrintList = new LabelPrintLog();
							...
							InsidelabelPrintList.setProduction_Date(PrintDate_textField.getText());
							InsidelabelPrintList.setNet_Weight(net_weight_textField.getText());
							InsidelabelPrintList.setGross_Weight(gross_weight_textField.getText());
	 ...
	 * @throws SQLException
	 */
	private void fillTable(LabelPrintLog labelPrintLog) throws SQLException {
		LabelPrintLogDao labelPrintLogDao = new LabelPrintLogDao();
